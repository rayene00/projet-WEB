    ...
    <section class="partenaires">
        ...
        <div class="logos">
            <a href="https://www.airbus.com" target="_blank">
                <img src="{{ asset('assets/images/airbus.png') }}" alt="Airbus">
            </a>
            <a href="https://www.vinci.com" target="_blank">
                <img src="{{ asset('assets/images/vinci.png') }}" alt="Vinci">
            </a>
            ...
            <a href="https://totalenergies.com" target="_blank">
                <img src="{{ asset('assets/images/total.png') }}" alt="TotalEnergies">
            </a>
        </div>
    </section>
